...
void detKeypointsHarris(vector<cv::KeyPoint> &keypoints, cv::Mat &img, bool bVis)
{
    ...
    // each maximum. The resulting coordinates is stored in a list of keypoints
    // of the type `vector<cv::KeyPoint>`.
    // Find prominent corners and instantiate keypoints
...
// Detect keypoints in image using detectorType as FAST, BRISK, ORB, AKAZE, SIFT
